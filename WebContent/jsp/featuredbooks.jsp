...
<%
out.println("<ul>");
	out.println("<div class="+"box-heading"+">Featured</div>");
...
while (rs.next()) {
			...
			out.println("<div class="+"image2"+">");
			out.println("<a href="+"#"+">");
				out.println("<img alt="+title+" src='"+imagesrc+"'>");
					out.println("</a>");
				out.println("</div>");
			out.println("<div class="+"name maxheight-feat"+" style="+"height: 38px;"+">");
			out.println("<a href="+"#>"+title+"</a>");
				out.println("</div>");
			//out.println("<div class="+"price>Rs: "+price+" </div>");
