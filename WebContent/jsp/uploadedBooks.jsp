...
rs = statement.executeQuery("SELECT * FROM Books WHERE UserID='" + userID + "'");

%>                           

<div class="box-heading">My Uploaded Books</div>
<div class="product-list" style="overflow: auto; height:800px;">
        ...
        <div>
            <div class="right">
                ...
                <div class="cart"><a onclick="editBooks('<% out.print(bookID);%>');" class="button"><span>Edit Details...</span></a></div>
                <div class="cart"><a onclick="deleteBooks('<% out.print(bookID);%>');" class="button"><span>Remove Book</span></a></div>
            </div>
            <div class="left">
                <div class="image">
